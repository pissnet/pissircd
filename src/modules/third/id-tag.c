...
int idtag_mtag_is_ok(Client *client, char *name, char *value);
void mtag_add_idtag(Client *client, MessageTag *recv_mtags, MessageTag **mtag_list, char *signature);
int idtag_mtag_can_send(Client *target);
...
MOD_INIT()
{
	...
	mtag.can_send = idtag_mtag_can_send;
