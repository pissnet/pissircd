...
int hiddenopertag_mtag_is_ok(Client *client, const char *name, const char *value);
void mtag_add_hiddenopertag(Client *client, MessageTag *recv_mtags, MessageTag **mtag_list, const char *signature);
int hiddenopertag_mtag_should_send_to_client(Client *target);
...
MOD_INIT()
{
	...
	mtag.should_send_to_client = hiddenopertag_mtag_should_send_to_client;
